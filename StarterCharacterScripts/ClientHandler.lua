...
-------------------------
--| Created by Dubanity
--| Thanks to Uctron for hidden API functions
--| Thanks to CleverSource for original head-follow-mouse method using R15
--| Thanks to Headstackk and vastqud for similar methods
--| Thanks to Anubiantic for original models and idea planning
--| Thanks to isayiah for helpful tips with welds and general math and physics concepts
--| Thanks to Delros2 for original gun sway method using trigonometry as a base and lots of error handling solutions
...
-------------------------
--[[
    Altering from R6 to R15 would yield the following code:
    
    1: Changing Torso to be UpperTorso
    2: Adding Waist
    3: Checking if Neck and Waist are present
    4: Adding WasitOriginC0
    5: Adding Lerp function for Waist
--]]
